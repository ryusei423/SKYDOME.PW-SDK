...
namespace F::AUTOWALL {
    ...
    public:
        struct data_t {
            ...
            __forceinline data_t(const Vector local_pos, const Vector target_pos,
                C_BaseEntity* target,
                C_BaseEntity* local,
            ...
            std::array< Vector, static_cast<int>(sizeof(e_pos)) > m_pos{ };
        ...
        void pen(data_t& data, const Vector local_pos, const Vector target_pos, C_BaseEntity* target, C_BaseEntity* local, C_CSPlayerPawn* localpawn, C_CSPlayerPawn* targetpawn,
    ...
    public:
        [[nodiscard]] __forceinline auto get_data(data_t& data) const noexcept { return data; }
    };
