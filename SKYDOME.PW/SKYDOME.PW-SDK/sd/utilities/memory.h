...
namespace MEM
{
	...
	[[nodiscard]] __forceinline std::uint8_t* ResolveRelativeAddress(std::uint8_t* nAddressBytes, std::uint32_t nRVAOffset, std::uint32_t nRIPOffset)
	{
		...
		//nRIPOffset是当前操作数的大小，用于定位到下一条指令
		//https://www.unknowncheats.me/forum/assembly/162969-x64-call-addresses-etc.html
		//https://www.unknowncheats.me/forum/counter-strike-2-a/630606-signatures.html
		//https://www.unknowncheats.me/forum/2398967-post4897.html
		//一些跟这个技术有关的帖子，有些事情我还是不太理解，今晚我要编写本地化
	...
	inline unsigned long(__stdcall* fnUnDecorateSymbolName)(const char* szName, char* pszOutput, unsigned long nMaxStringLength, unsigned long dwFlags) = nullptr;
	...
	inline int(__stdcall* fnSetWindowMouseGrab)(void*, int) = nullptr;
	inline bool(__stdcall* fnGetRelativeMouseMode)(void) = nullptr;
	inline int(__stdcall* fnWarpMouseInWindow)(void*, float, float) = nullptr;
